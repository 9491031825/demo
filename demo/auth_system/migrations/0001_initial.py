    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('old_quantity', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('new_quantity', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('old_avg_cost', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('new_avg_cost', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.CharField(blank=True, help_text='Username of the user who created this transaction', max_length=150, null=True)),
